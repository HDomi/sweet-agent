...
def main():
    ...
    # Glob mode: repo_root/tests/sweet-compress/
    # __file__ lives at <repo_root>/skills/sweet-compress/scripts/benchmark.py
    # Walk up four dirs: scripts → sweet-compress → skills → repo_root.
    tests_dir = Path(__file__).resolve().parents[3] / "tests" / "sweet-compress"
